...
class Constants:
    def __init__(self):
        ...
        self.APP_VERSION = "v4.1c"
        self.APP_RELEASE_DATE = "2026-Jan-13"
        ...
        self.LANDING_PAGE_SORT_KEY = "landing_page_sort"
        self.LANDING_PAGE_GAME_FILTER_KEY = "landing_page_game_filter"
