        ...
        super().__init__(
            *args,
            custom_col_data=[
                ...
                custom_components.CustomGridview.CustomColumn('Exp', 'total_xp', width=80),
                custom_components.CustomGridview.CustomColumn('Exp/sec', 'experience_per_second', width=80),
