...
from route_recording.game_recorders.gen_five.platinum_fsm import Machine

import route_recording.recorder
from route_recording.game_recorders.gen_five import platinum_states
from route_recording.game_recorders.gen_five.platinum_gamehook_constants import gh_gen_five_const, GameHookConstantConverter
...
class PlatinumRecorder(route_recording.recorder.RecorderGameHookClient):
    def __init__(self, controller:route_recording.recorder.RecorderGameHookClient, expected_names:List[str], is_hgss=False):
        ...
        if is_hgss:
            gh_gen_five_const.configure_for_black2()
        else:
