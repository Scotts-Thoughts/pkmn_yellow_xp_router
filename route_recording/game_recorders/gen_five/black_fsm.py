...
class Machine:
    def __init__(self, controller:route_recording.recorder.RecorderController, gamehook_client:route_recording.recorder.RecorderGameHookClient, gh_converter:GameHookConstantConverter, is_white=False):
    ...
    def shutdown(self):
        logger.info("Shutting down Black/White recording FSM")
        self._active = False
